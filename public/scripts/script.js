const id = "text";
repeat(0, ["thjemen", "Thymen", "TheVRuniverse", "TheVRcomrade", "pro cat thief"], [0, 128, 4096, 64]) // delays: [textDelay, typeDelay, beforeEraseDelay, eraseDelay]
...
async function type(text, delays) {
    ...
    return new Promise((resolve, reject) => {
        ...
        function removeLetter() {
            ...
            if (div.textContent.length) setTimeout(removeLetter, delays[2] ? delays[2] : 40);
            else resolve();
        }
    });
}